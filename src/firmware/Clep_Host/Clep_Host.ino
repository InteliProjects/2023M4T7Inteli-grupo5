...
#define CHANNEL 3 // Número do canal para comunicação ESPNow
#define PRINTSCANRESULTS 0 // Flag para imprimir resultados da varredura
#define DELETEBEFOREPAIR 0 // Flag para deletar dispositivos antes de parear

esp_now_peer_info_t slave; // Estrutura para armazenar informações sobre o dispositivo escravo
const int pinFoundSlave = 17; // Pino indicador se um dispositivo escravo foi encontrado
